import userOneImg from "../assets/images/testimonial-1.jpg";
import serviceOneImg from "../assets/images/service-1.jpg";
import serviceTwoImg from "../assets/images/service-2.jpg";
import serviceThreeImg from "../assets/images/service-3.jpg";
import caseOneImg from "../assets/images/service-1.jpg";
export const stats = [
    {
        value: 10,
        suffix: "+",
...
export const services = [
    {
        ...
        description:
            "Focused legal support to help clients pursue fair compensation after accidents or injuries.",
    ...
    },
    {
        ...
        category: "Family Law",
        description:
            "Guidance and representation for sensitive family matters including divorce, custody, and support.",
    ...
    },
    {
        ...
        description:
            "Strong legal defense to protect your rights and ensure fair treatment within the justice system.",
    ...
    },
    {
        ...
        description:
            "Strategic legal guidance for businesses on contracts, disputes, and regulatory compliance.",
        thumbnail: serviceOneImg,
    },
    {
        ...
        description:
            "Legal assistance for property transactions, disputes, and real estate documentation.",
        thumbnail: serviceTwoImg,
    },
    {
        ...
        description:
            "Professional legal consultations to help you understand your options before taking action.",
        thumbnail: serviceThreeImg,
    },
];
